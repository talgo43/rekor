...
func (m *PkgTypesJarV001JarV001Schema) validateArchive(formats strfmt.Registry) error {
...
func (m *PkgTypesJarV001JarV001Schema) validateSignature(formats strfmt.Registry) error {
...
func (m *PkgTypesJarV001JarV001Schema) contextValidateArchive(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PkgTypesJarV001JarV001Schema) contextValidateSignature(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PkgTypesJarV001JarV001Schema) UnmarshalBinary(b []byte) error {
	var res PkgTypesJarV001JarV001Schema
...
func (m *PkgTypesJarV001JarV001SchemaArchive) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PkgTypesJarV001JarV001SchemaArchive) validateHash(formats strfmt.Registry) error {
...
func (m *PkgTypesJarV001JarV001SchemaArchive) contextValidateHash(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PkgTypesJarV001JarV001SchemaArchive) UnmarshalBinary(b []byte) error {
	var res PkgTypesJarV001JarV001SchemaArchive
	if err := jsonutils.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
func (m *PkgTypesJarV001JarV001SchemaArchiveHash) Validate(formats strfmt.Registry) error {
	var res []error
...
var pkgTypesJarV001JarV001SchemaArchiveHashTypeAlgorithmPropEnum []any
...
func init() {
	...
	for _, v := range res {
		pkgTypesJarV001JarV001SchemaArchiveHashTypeAlgorithmPropEnum = append(pkgTypesJarV001JarV001SchemaArchiveHashTypeAlgorithmPropEnum, v)
	}
}
...
// prop value enum
func (m *PkgTypesJarV001JarV001SchemaArchiveHash) validateAlgorithmEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, pkgTypesJarV001JarV001SchemaArchiveHashTypeAlgorithmPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PkgTypesJarV001JarV001SchemaArchiveHash) validateAlgorithm(formats strfmt.Registry) error {
...
func (m *PkgTypesJarV001JarV001SchemaArchiveHash) validateValue(formats strfmt.Registry) error {
...
func (m *PkgTypesJarV001JarV001SchemaArchiveHash) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
...
func (m *PkgTypesJarV001JarV001SchemaArchiveHash) UnmarshalBinary(b []byte) error {
	var res PkgTypesJarV001JarV001SchemaArchiveHash
	if err := jsonutils.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
func (m *PkgTypesJarV001JarV001SchemaSignature) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PkgTypesJarV001JarV001SchemaSignature) validateContent(formats strfmt.Registry) error {
...
func (m *PkgTypesJarV001JarV001SchemaSignature) validatePublicKey(formats strfmt.Registry) error {
...
func (m *PkgTypesJarV001JarV001SchemaSignature) contextValidateContent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PkgTypesJarV001JarV001SchemaSignature) contextValidatePublicKey(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PkgTypesJarV001JarV001SchemaSignature) UnmarshalBinary(b []byte) error {
	var res PkgTypesJarV001JarV001SchemaSignature
	if err := jsonutils.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
func (m *PkgTypesJarV001JarV001SchemaSignaturePublicKey) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PkgTypesJarV001JarV001SchemaSignaturePublicKey) validateContent(formats strfmt.Registry) error {
...
func (m *PkgTypesJarV001JarV001SchemaSignaturePublicKey) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
// MarshalBinary interface implementation
func (m *PkgTypesJarV001JarV001SchemaSignaturePublicKey) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return jsonutils.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *PkgTypesJarV001JarV001SchemaSignaturePublicKey) UnmarshalBinary(b []byte) error {
	var res PkgTypesJarV001JarV001SchemaSignaturePublicKey
	if err := jsonutils.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
